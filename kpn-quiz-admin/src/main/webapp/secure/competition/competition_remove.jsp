                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form:form id="form" commandName="competitionModel"
                                       action="${pageContext.request.contextPath}/secure/competition/remove/confirm/${competitionModel.id}"
                                       method="POST">
                                <form:hidden path="id"/>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <form:input path="name" placeholder="Insert your competition Name"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <button class="btn btn-primary btn-block" type="button"
                                                onclick="location.href='${pageContext.request.contextPath}/secure/competition/list';">
