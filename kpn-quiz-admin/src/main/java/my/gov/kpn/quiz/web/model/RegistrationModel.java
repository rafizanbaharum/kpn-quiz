...
public class RegistrationModel extends MetaModel {
    ...
    public Map<String, String> getNegeris() {
        return negeris;
    }

    public void setNegeris(Map<String, String> negeris) {
        this.negeris = negeris;
    }
}
